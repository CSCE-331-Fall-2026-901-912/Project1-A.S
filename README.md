...
- Notion, Google Calendar, Apple Notes, Todoist, Gmail, LinkedIn, and GitHub icons — pulled via Google's favicon service (`https://www.google.com/s2/favicons?...`)

App / profile links used on the "Core Principles and Workflow" page:
- Notion — `https://www.notion.so`
- Google Calendar — `https://calendar.google.com`
- Canvas — `https://parents.canvaslms.com/`
- Apple Notes (support guide, since Apple Notes has no public web app) — `https://support.apple.com/guide/notes/welcome/mac`
...
2. "Do not include my resume, skills, or activities because those are included in my other pages."
3. "Also can you replace the productivity apps with hyperlinks in each of them to the apps: Notion, Google Calendar, Canvas, Apple Notes, and Todoist"
4. "make the productivity apps one row across, because space is not getting used efficiently right now"
5. "The canvas logo is wrong, I want the canvas edu logo - white background with red for school use"
6. "This is the link to canvas, use this logo https://parents.canvaslms.com/"
7. "Give the page a block layout, with tables (borders) around text."
